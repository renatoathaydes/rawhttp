...
class TcpRawHttpServerTests {
    ...
    @Test
    fun `Server can handle successful http client request`() {
    ...
    @Test
    fun `Server can handle multiple successful http client requests, including HEAD request`() {
    ...
    @Test
    fun `Server can handle wrong method http client request`() {
    ...
    @Test
    fun `Server can handle wrong path http client request`() {
    ...
    @Test
    fun `Server returns default error response when router throws an Exception`() {
    ...
    @Test
    fun `Server returns default error response when request handler throws an Exception`() {
    ...
    @Test
    fun `Server returns default error response when request handler returns null`() {
    ...
    @Test
    fun `Server should persist connection on all HTTP1_1 requests`() {
    ...
    @Test
    fun `Server should close connection on HTTP1_1 requests if 'Connection close' header is sent`() {
        val socket = Socket("0.0.0.0", 8093)
        http.parseRequest(
            "GET /hello HTTP/1.1\r\n" +
                    "Host: localhost\r\n" +
    ...
    @Test
    fun `Server should close connection on HTTP1_0 requests`() {
        val socket = Socket("0.0.0.0", 8093)
    ...
    @Test
    fun `Server should persist connection on HTTP1_0 requests if 'Connection keep-alive' header is sent`() {
        val socket = Socket("0.0.0.0", 8093)
        http.parseRequest(
            "GET /hello HTTP/1.0\r\n" +
                    "Host: localhost\r\n" +
    ...
    @Test
    fun `Server honours http client request desire to use 100-Continue`() {

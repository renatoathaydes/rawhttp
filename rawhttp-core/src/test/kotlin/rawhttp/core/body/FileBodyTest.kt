...
class FileBodyTest {
    ...
    @Test
    fun `It is possible to add a file body to a HTTP Request with no body`() {
    ...
    @Test
    fun `It is possible to replace the body of a HTTP Request with a file body`() {
        val request = RawHttp().parseRequest(
            "PUT localhost:8080/404\r\n" +
                    "Content-Length: 4\r\n\r\n" +
                    "ABCD"
        )
    ...
    @Test
    fun `It is possible to add a file body to a HTTP Response with no body`() {
    ...
    @Test
    fun `It is possible to replace the body of a HTTP Response with a file body`() {

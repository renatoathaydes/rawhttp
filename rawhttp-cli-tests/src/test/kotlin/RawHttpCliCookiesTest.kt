...
class RawHttpCliCookiesTest {
    ...
    fun canRunHttpFileThatRequiresCookiesUsingEnvironmentAndEndingInTestFailure() {
        ...
        outLines.subList(0, 9) shouldBe listOf(
            "HTTP/1.1 302",
            "Location: http://localhost:8086/login",
            "Content-Length: 0",
            "",
        ...
        outLines.subList(10, 14) shouldBe listOf(
        ...
        outLines.subList(15, 19) shouldBe listOf(
            "HTTP/1.1 401 Bad Credentials",
            "Content-Length: 0",
            "",
            ""
    ...
    fun canRunHttpFileUsingPreLoadedCookies() {
        ...
        outLines.subList(0, 5) shouldBe listOf(
            "HTTP/1.1 200 OK",
            "Content-Type: text/plain",
            "Content-Length: 10",
            "",
    ...
    private fun assertHttpFileRanSuccessfully(handle: ProcessHandle) {
        ...
        outLines[14] shouldMatch ("TEST OK \\(\\d+ms\\): We get the bad credentials response")
        outLines.subList(15, 21) shouldBe listOf(
            "HTTP/1.1 200 OK",
            "Content-Type: text/plain",
            "Content-Length: 9",
        ...
        outLines.subList(22, 27) shouldBe listOf(
            "HTTP/1.1 200 OK",
            "Content-Type: text/plain",
            "Content-Length: 10",
            "",
